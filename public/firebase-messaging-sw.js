...
self.addEventListener('notificationclick', function(event) {
  ...
  // Construct the absolute URL with explicit hash
  const urlToOpen = new URL('/#alerts', self.location.origin).href;
...
const CACHE_NAME = 'fleetdost-v15-force-refresh';
